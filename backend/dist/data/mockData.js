...
exports.MockDatabaseStore = void 0;
class MockDatabaseStore {
    students = [
        { id: "stu_001", name: "Maya Patel", email: "maya.patel@school.edu", grade: 11, gpa: 3.2, counselorId: "csl_001", enrollmentStatus: "at_risk" },
        { id: "stu_002", name: "Jordan Lee", email: "jordan.lee@school.edu", grade: 12, gpa: 3.8, counselorId: "csl_001", enrollmentStatus: "active" },
        { id: "stu_003", name: "Carlos Rivera", email: "carlos.rivera@school.edu", grade: 10, gpa: 2.4, counselorId: "csl_001", enrollmentStatus: "at_risk" }
    ];
    tasks = [
...
exports.MockDatabaseStore = MockDatabaseStore;
